...
contract Agent {
    ...
    event AgentPromptUpdated(string indexed newPrompt);
    ...
    constructor(
        ...
        config = IOracle.OpenAiRequest({
            ...
            tools : "[{\"type\":\"function\",\"function\":{\"name\":\"web_search\",\"description\":\"Search the internet using Google to look for the most recent news about the stocks markets in the United States and return the full title of the articles. Please ignore the web search results that don't give any relevant information about the current state of the stocks markets\",\"parameters\":{\"type\":\"object\",\"properties\":{\"query\":{\"type\":\"string\",\"description\":\"Search query\"}},\"required\":[\"query\"]}}},{\"type\":\"function\",\"function\":{\"name\":\"image_generation\",\"description\":\"Generates an image using Dalle-2\",\"parameters\":{\"type\":\"object\",\"properties\":{\"prompt\":{\"type\":\"string\",\"description\":\"Dalle-2 prompt to generate an image\"}},\"required\":[\"prompt\"]}}}]",
    ...
    function setPrompt(string memory systemPrompt) public onlyOwner {
        require(msg.sender == owner, "Caller is not the owner");
        prompt = systemPrompt;
        emit AgentPromptUpdated(systemPrompt);
    }
